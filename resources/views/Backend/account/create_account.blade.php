            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{route('create_account')}}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- <div class="form-group">
                                <label for="exampleInputName1">Account Number</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="acc_number" name="acc_number" value="{{$accountNumber}}" style="background:none; outline:none; color:red" require>
