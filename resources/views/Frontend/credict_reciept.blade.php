                        ...
                        <div class="col-lg-6 col-md-12 p-0">
                            <div class="login-content">
                                ...
                                <div style="display:flex; justify-content:space-between; width:100%; align-items:center; color:black">
                                    ...
                                    <p style="font-weight:500">{{$trans->created_at->format('jS F Y | h:i')}}</p>
                                </div>
                                ...
                                <div style="display:flex; justify-content:space-between; width:100%; align-items:center; color:black">
                                    <p style="color: black; font-weight:bold">Sender Account</p>

                                    <p style="font-weight:500">*******{{substr($trans->sender_acc, -3)}}</p>
                                </div>
                                ...
                                <div style="display:flex; justify-content:space-between; width:100%; align-items:center; color:black">
                                    <p style="color: black; font-weight:bold">Sender's Bank</p>
